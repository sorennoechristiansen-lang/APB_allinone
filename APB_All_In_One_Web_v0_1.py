...
def admin_panel():
    ...
    if pw!=configured:
        ...
        return
    st.caption("For this proof of concept the engine uses the same JSON files as the desktop builder. Uploading replaces the server copy.")
