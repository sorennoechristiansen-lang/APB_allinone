...
def render_builder():
    ...
    with st.expander(structure_heading,expanded=(st.session_state.get("_open_target_section")=="structure")):
        ...
        structure_profile=st.selectbox("Structure profile",_profile_options(STRUCTURE_TARGET_PROFILES),index=0,key="structure_profile",on_change=_keep_target_section_open,args=("structure",))
    ...
    with st.expander(sector_heading,expanded=(st.session_state.get("_open_target_section")=="sector")):
        ...
        sector_profile=st.selectbox("Sector profile",_profile_options(SECTOR_TARGET_PROFILES),index=0,key="sector_profile",on_change=_keep_target_section_open,args=("sector",))
    ...
    with st.expander(region_heading,expanded=(st.session_state.get("_open_target_section")=="region")):
        ...
        region_profile=st.selectbox("Region profile",_profile_options(REGION_TARGET_PROFILES),index=0,key="region_profile",on_change=_keep_target_section_open,args=("region",))
