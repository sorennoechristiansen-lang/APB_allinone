...
def render_builder():
    ...
    with c2: st.text_input("Portfolio value",value="100.000",key="portfolio_value_display",help="Use e.g. 100.000 for 100,000.")
    with c3: st.text_input("Minimum position",value="5.000",key="minimum_position_display",help="Use e.g. 5.000 for 5,000.")
