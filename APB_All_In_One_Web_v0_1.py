...
def render_builder():
    ...
    with st.expander(structure_heading,expanded=False):
    ...
    with st.expander(sector_heading,expanded=False):
    ...
    with st.expander(region_heading,expanded=False):
    ...
    with st.expander(industry_heading,expanded=False):
