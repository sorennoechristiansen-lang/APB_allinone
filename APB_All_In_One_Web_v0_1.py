# APB All-In-One Web v0.18
# v0.18: Adds first-use validation for Currency/capital/minimum position/stock count, synchronized sliders for the three numeric basic rules, and a web Dividend preference with Off/On heading, High priority and 3% target. Result view/PDF show weighted portfolio dividend yield.
...
# Porteføljebygger v0.18
# v0.18: Fase 0 – tilføjer Region, Sektor og Industri efter Status. Kolonnerne er sorterbare.
# Porteføljebygger v0.18
# v0.18: Fase 0 – Aktieunivers kan sorteres på alle kolonner via klik på overskriften.
# Gentaget klik skifter stigende/faldende, og aktiv kolonne markeres med ▲/▼.
# Porteføljebygger v0.18
# v0.18: Udbytteoversigten låser nu præcis den aktuelt viste Fase 2-portefølje ved klik.
# Porteføljen genindlæses eller genopbygges ikke under udbytteopdateringen; kun udbyttefelter opdateres.
# Match sker entydigt på børs+ticker, mens layout og progress-visning fra v0.18 bevares.
# Porteføljebygger v0.18
# v0.18: Udbytteoversigtens layout er genetableret til v0.12-layoutet uændret.
...
# Porteføljebygger v0.18
# v0.18: Udbytteoversigten bruger portefolje_fase2.json som entydig sandhedskilde,
# opdaterer udbyttedata for netop disse positioner og genopbygger Fase 2 før visning.
# v0.18: Udbytteoversigten synkroniseres altid med den senest byggede portefølje.
...
# Industripræferencerne fra v0.18 bevares uændret.
