...
def render_builder():
    ...
    if not st.session_state.get("_basic_rules_v010_initialized",False):
        ...
        st.session_state["_basic_rules_v010_initialized"]=True
    ...
    with top4:
        _basic_number_with_slider(
            "Number of different stocks","maximum_stocks",100,1,
            "APB builds the portfolio using this number of different stocks, provided the selected rules can be satisfied.",
        )
